...
for (let i = 0; i < scores.length; i++) {
    if (scores[i].score < 60) console.log("F")
    else if (scores[i].score < 70) console.log("D")
    else if (scores[i].score < 80) console.log("C")
    else if (scores[i].score < 90) console.log("B")
    else if (scores[i].score <= 100) console.log("A")
    else console.log("Unvalid score")
}
...
for (let i = 0; i < scores.length; i++) {
    ...
    else if (scores[i].score <= 100) scores[i].grade = "A"
    else scores[i].grade = "No grade available due to unvalid score"
}
